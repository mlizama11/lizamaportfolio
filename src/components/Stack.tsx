...
export default function Stack() {
  const myStack = [
    ...
    { name: 'Shadcn UI', icon: SiShadcnui, color: 'text-gray-900' },
    { name: 'Radix UI', icon: SiRadixui, color: 'text-gray-900' },
    ...
    { name: 'SWR', icon: SiSwr, color: 'text-black' },
    { name: 'React Router', icon: SiReactrouter, color: 'text-gray-900' },
    { name: 'Node.js', icon: SiNodedotjs, color: 'text-green-600' },
    { name: 'Auth0', icon: SiAuth0, color: 'text-black' },
    { name: 'Postman', icon: SiPostman, color: 'text-orange-500' },
    { name: 'Express', icon: SiExpress, color: 'text-gray-700' },
    { name: 'NestJS', icon: SiNestjs, color: 'text-red-600' },
    { name: 'Prisma', icon: SiPrisma, color: 'text-gray-900' },
    { name: 'MongoDB', icon: SiMongodb, color: 'text-green-700' },
    { name: 'MySQL', icon: SiMysql, color: 'text-cyan-700' },
    { name: 'Git & GitHub', icon: SiGithub, color: 'text-gray-900' },
  ];
  return (
    <section id="stack">
      <div className="flex flex-col gap-8">
        ...
        <div className="grid grid-cols-1 gap-4 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-4">
          {myStack.map(({ name, icon: Icon, color }) => (
            <div
              key={name}
              className="flex items-center gap-4 rounded-lg border border-gray-200 p-3 shadow-sm transition-shadow hover:shadow-md"
            >
              <div>
